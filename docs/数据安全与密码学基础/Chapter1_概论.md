...
<img src="images/image1-1.png" style="display: block; width: 60%; margin: 0 auto;" />
<br>

* 对任意加密方案的基本要求是：对于任意通过 $\text{Gen}$ 输出的密钥 $k$，每个明文消息 $m \in \mathcal{M}$，满足 $$\text{Dec}_k(\text{Enc}_k(m)) = m$$

!!! info 加密方案的正确性
    $$\forall m \in M,\ \underset{sk\leftarrow Gen}{\Pr}\ [Dec(Enc(sk,m))=m]=1$$
...
<img src="images/image1-2.png" style="display: block; width: 90%; margin: 0 auto;" />
<br>
...
<img src="images/image1-3.png" style="display: block; width: 50%; margin: 0 auto;" />
